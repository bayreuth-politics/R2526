...
__You must create a single output file which includes your code, R output (figures, tables, etc.) and substantive responses. You further must submit all materials you used (data and ALL your code) so that your results are fully replicable.__ 
